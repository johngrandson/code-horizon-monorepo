defmodule PetalProWeb.LandingPageComponents do
        ...
        <div class="flex flex-wrap items-center -mx-3 overflow-hidden">
          ...
          <div class="w-full px-3 mb-12 xl:pl-16 xl:w-2/3 lg:mb-0">
            <div class="flex items-center justify-center lg:h-128">
              ...
              <img
                id="hero-image-dark"
                class="fade-in-from-right-animation w-[76rem] rounded-md bg-white/5 ring-1 ring-white/10 hidden dark:block"
                src={@image_src_dark}
                alt="Hero image dark"
              />
            </div>
  ...
  def features(assigns) do
    ...
    <section
      id="features"
      class="relative z-10 py-16 mt-24 overflow-hidden text-center bg-white md:pt-16 md:pb-32 dark:bg-gray-950 dark:text-white"
    >
                ...
                <div class="flex flex-col items-center justify-between h-full p-12">
                  <div class="flex justify-center mb-4 md:mb-6">
                    <div class="relative flex items-center justify-center w-16 h-16 border border-transparent shadow-2xl rounded-2xl [background:linear-gradient(theme(colors.gray.50),_theme(colors.gray.50))_padding-box,_conic-gradient(theme(colors.gray.200),_theme(colors.gray.100)_25%,_theme(colors.gray.100)_75%,_theme(colors.gray.200)_100%)_border-box] dark:[background:linear-gradient(theme(colors.gray.900),_theme(colors.gray.900))_padding-box,_conic-gradient(theme(colors.gray.400),_theme(colors.gray.700)_25%,_theme(colors.gray.700)_75%,_theme(colors.gray.400)_100%)_border-box] before:absolute before:inset-0 dark:before:bg-gray-800/30 before:rounded-2xl">
                      <.icon
                        name={feature.icon}
                        class="relative w-6 h-6 text-gray-900 dark:text-gray-200"
                      />
                    </div>
                  </div>
                  <!-- Text -->
                  ...
                  <div>
                    <a
                      class="relative text-gray-500 transition duration-150 ease-in-out dark:text-gray-300 hover:text-gray-400 dark:hover:text-white before:absolute before:inset-0 dark:before:bg-gray-800/30 before:rounded-full before:pointer-events-none"
                      href="#0"
                    >
  ...
  def solo_feature(assigns) do
    ...
    <section
      id="benefits"
      class="relative z-10 py-16 overflow-hidden bg-white md:pt-24 md:pb-40 dark:bg-gray-950 dark:text-white"
      data-offset="false"
    >
      <.container max_width={@max_width} class="relative z-10 stagger-fade-in-animation">
        <.particles_animation class="fade-in-animation" />
        ...
        <div class={
          ...
          <div class="md:w-1/3 fade-in-animation">
            <div class="flex items-center justify-center w-16 h-16 mb-4 overflow-hidden rounded-full shadow-lg bg-gradient-to-tr from-primary-600/50 via-primary-600 to-primary-400 dark:from-primary-600/50 dark:via-primary-800 dark:to-primary-400 dark:highlight-white/10 shadow-primary-400/50 ring ring-white dark:ring-primary-400/80">
              <.icon name={@icon} class="w-8 h-8 text-primary-200" />
            </div>
          ...
          <div class="w-full lg:w-2/3 md:mt-0">
            <img
              class="z-10 w-full rounded-md shadow-2xl bg-white/5 ring-1 ring-white/10 fade-in-animation dark:hidden"
              src={@image_src_light}
              alt="Screenshot Light"
            />
            <img
              class="z-10 hidden w-full rounded-md shadow-2xl bg-white/5 ring-1 ring-white/10 fade-in-animation dark:block"
              src={@image_src_dark}
              alt="Screenshot Dark"
            />
          </div>
        ...
        <blockquote class="mt-6 md:grow md:flex md:flex-col">
          ...
          <footer class="mt-8">
            <div class="flex items-start">
              <div class="inline-flex shrink-0 border-2 border-white rounded-full">
