defmodule PetalProWeb.DataTable do
  @moduledoc """
  ...
  ## Example
      ...
      defmodule MyAppWeb.PostLive.Index do
        ...
        def handle_params(params, _url, socket) do
          starting_query = PetalPro.Widgets.Widget
  ...
  alias PetalProWeb.DataTable.Filter
  alias PetalProWeb.DataTable.FilterSet
  alias PetalProWeb.DataTable.Header
  ...
  attr :create_action, :string, required: false
  attr :create_label, :string, required: false

  def data_empty_state(assigns) do
    ~H"""
      ...
      >
        ...
        <g filter="url(#filter4)">
          ...
          <rect
            ...
            rx="7.5"
            stroke="currentColor"
            class="stroke-stone-100 dark:stroke-neutral-700/60"
            shape-rendering="crispEdges"
          />
          <rect
            x="20"
