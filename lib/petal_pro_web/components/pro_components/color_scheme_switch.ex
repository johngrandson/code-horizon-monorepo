defmodule PetalProWeb.ColorSchemeSwitch do
  @moduledoc false
  ...
  def color_scheme_switch(assigns) do
    ...
    <button
      ...
      class={"color-scheme text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-hidden focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 #{@class}"}
    >
      <svg
