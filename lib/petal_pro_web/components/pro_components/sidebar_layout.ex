defmodule PetalProWeb.SidebarLayout do
  @moduledoc """
  A responsive layout with a left sidebar (main menu), as well as a drop down menu up the top right (user menu).

  Uses PetalProWeb.SidebarMenu.sidebar_menu/1 to render the main menu (see docs for menu items data structure). The user menu is rendered using PetalComponents.UserDropdownMenu.user_dropdown_menu/1.
  ...
  import PetalProWeb.SidebarMenu
