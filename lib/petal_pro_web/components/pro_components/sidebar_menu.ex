defmodule PetalProWeb.SidebarMenu do
  @moduledoc """
  ...
  def nav_menu_group(assigns) do
    ...
    <nav>
      <h3
        :if={@title}
        class="pl-3 mb-3 text-xs font-semibold leading-6 text-gray-400 uppercase"
  ...
  defp menu_icon_classes, do: "w-5 h-5 shrink-0"

  defp menu_item_base,
    do: "flex items-center text-sm font-semibold leading-none px-3 py-2 transition duration-200 rounded-md group"
