      ...
      <.container class="py-16">
        ...
        <%= if @current_user.confirmed_at do %>
          ...
          <div class="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-4">
            <%= if @orgs != [] do %>
              <%= for org <- @orgs do %>
                <.link
                  ...
                  class="relative block w-full p-12 text-center text-gray-700 bg-gray-100 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:shadow-lg dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 dark:text-gray-400 dark:group-hover:text-gray-100"
                >
            ...
            >
              <.icon name="hero-plus" class="w-12 h-12 mx-auto" />
