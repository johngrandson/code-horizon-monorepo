          ...
          <.card>
            ...
            <.card_footer>
              <.button link_type="a" to="https://docs.petal.build" color="primary" target="_blank">
                <.icon name="hero-arrow-top-right-on-square" class="w-4 h-4 mr-2" /> Guide
              </.button>
            </.card_footer>
          </.card>
          ...
          <.card>
            ...
            <.card_footer>
              <.button
                ...
                color="primary"
              >
                <.icon name="hero-arrow-top-right-on-square" class="w-4 h-4 mr-2" /> Start learning
              </.button>
            </.card_footer>
          </.card>
          ...
          <.card>
            ...
            <.card_footer>
              <.button
                ...
                color="primary"
              >
                <.icon name="hero-arrow-top-right-on-square" class="w-4 h-4 mr-2" /> Petal Components
              </.button>
            </.card_footer>
          </.card>
        </div>
